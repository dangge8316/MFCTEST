...
// 缩略图的支持
void Cdraw1Doc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void Cdraw1Doc::InitializeSearchContent()
{
...
void Cdraw1Doc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
